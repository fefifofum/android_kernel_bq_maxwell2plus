...
static int sensor_enum_fmt(struct v4l2_subdev *sd, unsigned int index, enum v4l2_mbus_pixelcode *code)
{
...
#if lily_debug
int ov5642_write_proc (struct file *file, const char *buffer, unsigned long count, void *data)
{
...
int ov5642_read_proc (char *buffer, char **buffer_location, off_t offset, int buffer_length, int *zero, void *ptr)
{
	if(offset > 0)
		return 0;
	return offset;
